...
class ChatService {
  ...
  static const String n8nWebhookUrl = 'http://10.239.191.169:5678/webhook/chat';
  ...
  Future<String> sendMessageToN8n(String message) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        String assistantMessage = jsonResponse['message'] ?? 
        ...
        throw Exception('Failed to get response from n8n: ${response.statusCode}');
      }
    } catch (e) {
